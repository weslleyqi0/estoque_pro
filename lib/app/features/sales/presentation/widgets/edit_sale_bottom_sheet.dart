...
class _EditSaleBottomSheetState extends State<EditSaleBottomSheet> {
  ...
  Future<void> _loadProducts() async {
    final products = await getIt<ProductsRepository>().getAll();
    if (mounted) {
      setState(() {
      ...
      child: SafeArea(
        child: ListenableBuilder(
          ...
          builder: (context, _) {
            ...
            final isEdited = widget.sale.status == SaleStatus.edited;
            ...
            return Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            'Editar Venda ${widget.sale.saleNumber}',
                          ...
                          const Gap(4),
                          AppTag(
                            title: isEdited ? 'Editada' : widget.sale.status.label,
                ...
                // Middle section (Scrollable list of items and fields)
                Flexible(
                      ...
                      children: [
                                        ...
                                        Row(
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () => _viewModel.updateQuantity(item, item.quantity - 1),
                                            ),
                                            Text(
                                              '${item.quantity}',
                                              style: context.textTheme.titleMedium?.copyWith(
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: AppButton.text(
                                            onPressed: () => _showSwapProductDialog(context, item),
                                            icon: Icons.refresh,
                                            child: Text(
                                              'Trocar Item',
                                              style: context.textTheme.bodyMedium?.copyWith(
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () => _viewModel.removeItem(item),
                                        ),
                                      ],
                                    ),
                                  ],
                        ...
                        Wrap(
                          ...
                          children: _reasons.map((reason) {
                            final selected = _viewModel.selectedReason == reason;
                            return ChoiceChip(
                              label: Text(reason),
                              selected: selected,
                              onSelected: (_) => _viewModel.setReason(reason),
                            );
                          }).toList(),
                        ),
                ...
                // Footer (Fixed at bottom: Financial summary + Action Buttons)
                Padding(
                  padding: const EdgeInsets.all(AppSpacing.space16),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            CurrencyInputFormatter.formatCurrency(widget.sale.total),
                            style: context.textTheme.bodyMedium,
                          ),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            CurrencyInputFormatter.formatCurrency(_viewModel.newTotal),
                            style: context.textTheme.titleMedium?.copyWith(
                              fontWeight: FontWeight.bold,
                              color: context.colorScheme.primary,
                            ),
                      ...
                      Row(
                        children: [
                          if (_canCancel) ...[
                            Expanded(
                              child: AppButton.outlined(
                                onPressed: _viewModel.isSaving ? null : () => _onCancelSale(context),
                          ...
                          Expanded(
                            child: AppButton(
                              onPressed: (_viewModel.hasChanges && !_viewModel.isSaving)
                                  ? () => _onSave(context)
                                  : null,
